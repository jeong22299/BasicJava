...
public enum HomeMenu {
    ...
    HOME(-1, "✿---------------------------------------------------------------❀"
    		+ "\n| 1.회원가입\t8.로그인\t6.도서검색\t0.프로그램 종료 |\n"
    		+ "❀---------------------------------------------------------------✿"
    		+ "\n메뉴를 선택하세요: "), 
    QUIT(0, "👋프로그램을 종료합니다!\n이용해주셔서 감사합니다~👋\n"),  
    JOIN(1, "회원가입에 필요한 정보를 입력합니다.\n"),
    BORR_SELECT(100, "51.대출하기\t2.이전메뉴\n메뉴를 선택하세요: " ),
    BORR_SELECT2(110, "52.대출하기\t6.계속 검색하기\n메뉴를 선택하세요:" ),
    
    MYPAGE(2, "✿-------------------------------------------------------------------------------❀"
    		+ "\n| 3.회원정보\t4.대출정보\t5.도서검색\t9.로그아웃\t0.프로그램 종료 |"
    		+ "\n❀-------------------------------------------------------------------------------✿"
    		+ "\n메뉴를 선택하세요: "),
    MEMBER(3, "✿---------------------------------------------------------------------------------------------------------------❀"
    		+ "\n| 31.회원정보확인\t32.회원정보수정 \t33.회원탈퇴\t2.이전메뉴\t9.로그아웃\t0.프로그램 종료 |"
    		+ "\n❀---------------------------------------------------------------------------------------------------------------✿"
    		+ "\n메뉴를 선택하세요: "),
    BORR(4, "✿---------------------------------------------------------------------------------------------------------------❀"
    		+ "\n| 41.대출목록\t42.대출연장\t43.도서반납\t44.연체리스트\t2.이전메뉴\t9.로그아웃\t0.프로그램 종료 |"
    		+ "\n❀---------------------------------------------------------------------------------------------------------------✿"
    		+ "\n메뉴를 선택하세요: " ),
    ...
    MEMBER_MODIFY_INFO(32, "❀-------------------------------------------------------------------------------✿"
    		+ "\n| 321.이름\t322.주소\t323.휴대전화번호\t324.이메일\t325.비밀번호\t3.이전메뉴 |"
    		+ "\n❀-------------------------------------------------------------------------------✿"
    		+ "\n수정할 항목을 선택하세요: "),
    ...
    public static HomeMenu findMenu(int number) throws MenuNotFoundException {
        ...
        throw new MenuNotFoundException("선택하신 메뉴가 없습니다. 메인화면으로 돌아갑니다.");
    }
