...
public class BookVO {
	...
	public BookVO(int bookNum, String bookTt, String ath, String bookCfnCod) {
		super();
	...
	public BookVO(int bookNum, String bookTt, String ath , String bookCfnCod, String ascertain) {
		super();
		this.bookNum = bookNum;
		this.bookTt = bookTt;
		this.ath = ath;
